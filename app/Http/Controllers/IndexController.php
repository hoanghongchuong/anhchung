...
class IndexController extends Controller {
	...
	*/
	...
	public function index()
	{
		...
		return view('templates.index_tpl', compact('banner_danhmuc','com','khonggian_list','about','tintuc_moinhat','keyword','description','title','img_share','hot_news','news_product','hot_product','slider','banner_sidebar','cateHots','video','cate_pro','partners','slogans','feedback'));
	}
	...
	public function getNews()
	{
		...
		$products = DB::table('products')->where('status',1)->take('6')->orderBy('id','desc')->get();
		$com='tin-tuc';
		// Cấu hình SEO
		$title = "Tin tức";
		$keyword = "Tin tức";
    ...
    public function duan()
	{
		...
		$img_share = '';
		// End cấu hình SEO
		return view('templates.duan', compact('keyword','description','title','img_share','com', 'projects'));
	}
	...
	{
		$newProject = DB::table('news')->where('com', 'du-an')->where('status', 1)->orderBy('id','desc')->take(4)->get();
		...
		return view('templates.detailproject', compact('project','title','description', 'keyword','newProject'))	;
	}
	public function getDichvu()
	{
		...
		// Cấu hình SEO
		$title = "Dịch vụ";
		return view('templates.dichvu', compact('tintuc','hot_news','products','com','title'));
	}
