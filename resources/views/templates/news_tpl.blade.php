            ...
            <div class="col-md-9">
                ...
                <div class="box-service">
                    <div class="col-md-3 left">
                        <a href="{{url('tin-tuc/'.$item->alias.'.html')}}" class=""><img src="{{ asset('upload/news/'.$item->photo) }}" class="img-responsive" alt=""></a>
                    </div>
                    <div class="col-md-9">
                        <p class="service-name"><a href="{{url('tin-tuc/'.$item->alias.'.html')}}">{{$item->name}}</a></p>
