...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/css/gallary.css')}}">
    <link rel="stylesheet" href="{{ asset('public/css/new.css')}}">
    <link rel="stylesheet" href="{{ asset('public/css/style.css')}}">
    <link rel="stylesheet" href="{{ asset('public/css/trungtt.css')}}">
